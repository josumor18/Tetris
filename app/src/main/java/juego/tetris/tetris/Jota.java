...
public class Jota extends Forma {
            ...
            switch(posicion){
                case 1:
                    if((celda1.getFila()-1 >= 0
                            ...
                            && celda3.getFila()+1 < 18
                            && celda4.getFila()+2 < 18 && celda4.getColumna()+1 < 10)
                            ...
                            && !(MainActivity.matriz[celda4.getFila()+2][celda4.getColumna()+1]))){
                ...
                case 2:
                    if((celda1.getFila()-1 >= 0 && celda1.getColumna()+1 < 10
                            ...
                            && !(MainActivity.matriz[celda4.getFila()][celda4.getColumna()-2]))){
                        celda1.setFila(celda1.getFila()-1);
